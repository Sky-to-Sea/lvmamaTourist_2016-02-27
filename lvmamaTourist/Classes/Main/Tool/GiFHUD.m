...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(0, 0, WIDTH, HEIGHT)])) {
        ...
        self.imageView.origin = CGPointMake((WIDTH - 100) / 2.0, (HEIGHT - 100) / 2.0);
        self.imageView.size = CGSizeMake(100, 100);
        
        UIButton *closeBtn = [[UIButton alloc]init];
        closeBtn.size = CGSizeMake(15, 15);
        closeBtn.origin =  CGPointMake(self.imageView.x + self.imageView.width  - closeBtn.width ,self.imageView.y - 10);
...
+ (void)dismiss {
    ...
    [[[self instance] overlayer] removeFromSuperview];
